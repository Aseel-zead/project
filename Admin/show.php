					...
					<div class="card border-2 shadow">
						<div class="card-body">
							...
							<form action="" class="container-sm">
								<input type="text" name="id" id="id" value="ID Num. : <?php echo $id ; ?>" class="form-control my-4 py-2" placeholder="id" disabled />
								<input type="text" name="name" id="name" value="Name : <?php echo $name ; ?>" class="form-control my-4 py-2" placeholder="Name" disabled />
								<input type="text" name="email" id="email" value="Email : <?php echo $email ; ?>" class="form-control my-4 py-2" placeholder="Email" disabled />
