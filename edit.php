                ...
                <div class="col-10 col-sm-6 col-md-5 m-auto">
                    <div class="card border-2 shadow">
                            ...
                            <form action="" class="container-sm " method="POST">
                                <div class="row g-4 align-items-center">
                                    ...
                                    <div class="col-auto p-1">
                                        <input type="password" name="oldPassword" id="oldPassword" class="form-control " aria-labelledby="nameHelpInline" value="<?php echo $oldPassword; ?>" />
                                    </div>
                                </div>
                        ...
                        <div class="text-center mt-3">
                            <a href="showuser.php" class="btn btn-secondary  my-2" name='back' type="submit">Back</a>
